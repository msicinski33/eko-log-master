...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "EKO-LOG — Harmonogram odbiorów odpadów" },
      { property: "og:description", content: "Profesjonalny kalendarz wywozu odpadów dla mieszkańców i firm." },
      { property: "og:type", content: "website" },
      { name: "twitter:title", content: "EKO-LOG — Harmonogram odbiorów odpadów" },
      { name: "twitter:description", content: "Profesjonalny kalendarz wywozu odpadów dla mieszkańców i firm." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/f51b589e-fe7f-4c3a-944f-8873dfaf7b3b/id-preview-22b2b06d--511cfbcb-93aa-41c7-a0e9-a71096771c39.lovable.app-1779128355794.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/f51b589e-fe7f-4c3a-944f-8873dfaf7b3b/id-preview-22b2b06d--511cfbcb-93aa-41c7-a0e9-a71096771c39.lovable.app-1779128355794.png" },
